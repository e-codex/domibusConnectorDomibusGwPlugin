...
//    }
    ...
    public static String checkLocation(ApplicationContext ctx, String storeLocation) {
    ...
    public static void checkKeyStore(ApplicationContext ctx, String propName, String storeType, String location, String password) {
        if (storeType == null) {
