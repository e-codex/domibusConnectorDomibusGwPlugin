...
IF DEFINED DOMIBUS_CONFIG_LOCATION SET "CATALINA_OPTS=%CATALINA_OPTS% -Ddomibus.config.location=%DOMIBUS_CONFIG_LOCATION%"
IF NOT DEFINED DOMIBUS_CONFIG_LOCATION SET "CATALINA_OPTS=%CATALINA_OPTS% -Ddomibus.config.location=%CATALINA_HOME%\conf\domibus\"
IF DEFINED DOMIBUS_WORK_LOCATION SET "CATALINA_OPTS=%CATALINA_OPTS% -Ddomibus.work.location=%DOMIBUS_WORK_LOCATION%"
